var ScrollOutAll = function () {
    ...
    function H(e, t) { return e && 0 !== e.length ? e.nodeName ? [e] : [].slice.call(e[0].nodeName ? e : (t || E).querySelectorAll(e)) : [] } var L, P = function (e, t) { for (var n in t) e.setAttribute("data2-" + A(n), t[n]) }, b = []
    ...
    return function (h) {
        var o, c, l, i, g, p, t, s = (h = h || {}).onChange || O, f = h.onHidden || O, u = h.onShown || O, a = h.cssProps ? (o = h.cssProps, function (e, t) {
            ...
            i && (i = !1, l = H(h.targets || "[data2-scroll]", H(h.scope || X)[0]).map(function (e) { return { $: e, ctx: {} } }))
